...
class UserProviderManager:
    ...
    def _get_cipher(self):
        ...
        try:
            ...
            logger.error(f"[Security] Invalid ENCRYPTION_KEY provided: {e}")
            raise ValueError(f"ENCRYPTION_KEY format is invalid: {e}. Please use a 32-byte URL-safe base64 key.")
